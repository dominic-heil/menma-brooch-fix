const BROOCHES_WITH_NEW_BROOCH_SKILL = [291060, 291061, 291062, 291063, 291064, 291065, 291066, 291067, 293007, 296124, 296137]
...
exports.NetworkMod = function reee(mod) {
    ...
    function isBroochWithNewBroochSkill(id)
    {
        return (BROOCHES_WITH_NEW_BROOCH_SKILL.indexOf(id) > -1);
    }
    ...
    mod.hook("S_START_COOLTIME_ITEM", 1, event => {
        if (isBroochWithNewBroochSkill(event.item)) {
